...
2. **After it completes** – Read the created `.plan.md` file and summarize or reference it in your reply. If the command fails, report the error and suggest fixes (e.g. run `planforge init`, install the provider CLI).
